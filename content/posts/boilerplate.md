...
Em um relato anterior {{< ref "pacores-no-flutter.md" >}} descrevi alguns pacotes interessantes e cada um de nós pode montar um pubspec.yaml básico como esse a seguir:
